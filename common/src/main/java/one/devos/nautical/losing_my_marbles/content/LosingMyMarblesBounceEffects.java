...
import one.devos.nautical.losing_my_marbles.content.marble.effect.bounce.impl.ChancedBounceEffect;
import one.devos.nautical.losing_my_marbles.content.marble.effect.bounce.impl.CompoundBounceEffect;
...
public final class LosingMyMarblesBounceEffects {
	public static void init() {
		...
		register("chanced", ChancedBounceEffect.CODEC);
		register("compound", CompoundBounceEffect.CODEC);
