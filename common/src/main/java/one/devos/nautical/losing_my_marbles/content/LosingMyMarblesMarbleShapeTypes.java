...
import one.devos.nautical.losing_my_marbles.content.marble.data.shape.TaperedCapsuleMarbleShape;
...
public final class LosingMyMarblesMarbleShapeTypes {
	public static void init() {
		...
		register("tapered_capsule", TaperedCapsuleMarbleShape.TYPE);
	}
